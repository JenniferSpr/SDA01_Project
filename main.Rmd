...
However, out approach has several limitations. A football match depends on more than the difference between two Elo ratings. Player form, injuries, red cards, weather, travel and fatigue can all influence performance but are not captured by our models. In addition, modeling choices may influence results.
